...
class Debug {
    ...
    public static function dumpRef() {
        ...
        if (!headers_sent() && !ob_get_length())
            print '<!DOCTYPE HTML><html lang="<?php echo get_lng();?>"><head><title>REF</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /></head><body>';
